//Bypasses the techweb nodes with the exclusion of Experimental a.k.a. BEPIS tech, illegal tech, Combat Exosuits, and alien tech.
//Nodes are organized by their order of appearance in the code.
